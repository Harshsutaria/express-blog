let c = {
  ...
  surname: "sutaria",
  fullName: function () {
    console.log("name is ", this.name + " " + this.surname);
  },
};
...
/**
 * call apply bing are different ways for borrying a function from one object to another
 */
c.fullName.call(d);
...
console.log("fullName is ", member);
